...
public class MostActivePresenter {
    String baseApi;
    IMostActive view;
    String intURl;
    CompositeSubscription subscription = new CompositeSubscription();

    public MostActivePresenter(IMostActive view, int intURL) {
        this.intURl = String.valueOf(intURL);
//        this.baseApi = "http://gateway.fpts.com.vn/g5g/fpts/?s=top_realtime&c=" + intURL + "&type=3";
        this.view = view;
    }

    public void loadDataformServer() {
        subscription.add(ApiClientImp.getInstance().getTopRealtime(intURl, "3")
    ...
    public boolean getBooleanModeTheme() {
        SharedPreferences preferences = App.getInstance().getSharedPreferences(Define.SHARED_PREFRENCES_APP, App.getInstance().MODE_PRIVATE);

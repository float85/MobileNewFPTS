...
import mobile.fpts.com.ezmibile.model.JsonUtil;
...
public class ApiClientImp {
    ...
    public static final String API_URL = "https://eztrade3.fpts.com.vn/GateWAYDEV/";
    public static final String API_URL_GATEWAY = "http://10.26.2.46/GateWAY/";
    public static final String API_URL_MOCKABLE_IO = "http://demo3946559.mockable.io/";
    public static final String API_URL_OLD = "http://gateway.fpts.com.vn/g5g/";
    //"http://demo3946559.mockable.io/";
    //"https://eztrade3.fpts.com.vn/GateWAYDEV/fpts/";
    //http://10.26.2.46/GateWAY/";
...
//        }
    ...
    public static ApiClient getInstance_gateway() {
//        if (apiclient == null) {
//            OkHttpClient okHttpClient = newOkHttpInstance();
        OkHttpClient okHttpClient = newUnsafeOkHttpInstance();

        Retrofit restAdapter = newRetrofitInstance(API_URL_GATEWAY, okHttpClient);
        apiclient = restAdapter.create(ApiClient.class);
//        }
    ...
    public static ApiClient getInstance_String() {
//        if (apiclient == null) {
//            OkHttpClient okHttpClient = newOkHttpInstance();
        OkHttpClient okHttpClient = newUnsafeOkHttpInstance();

        Retrofit restAdapter = newRetrofitInstanceString(API_URL, okHttpClient);
        apiclient = restAdapter.create(ApiClient.class);
//        }
    ...
    public static ApiClient getInstance_OLD() {
//        if (apiclient == null) {
//            OkHttpClient okHttpClient = newOkHttpInstance();
        OkHttpClient okHttpClient = newUnsafeOkHttpInstance();

        Retrofit restAdapter = newRetrofitInstance(API_URL_OLD, okHttpClient);
        apiclient = restAdapter.create(ApiClient.class);
//        }
    ...
    public static ApiClient getInstance_MOCKABLE_IO() {
//        if (apiclient == null) {
//            OkHttpClient okHttpClient = newOkHttpInstance();
        OkHttpClient okHttpClient = newUnsafeOkHttpInstance();

        Retrofit restAdapter = newRetrofitInstance(API_URL_MOCKABLE_IO, okHttpClient);
        apiclient = restAdapter.create(ApiClient.class);
//        }
    ...
    private static Retrofit newRetrofitInstanceString(String endPoint, OkHttpClient okHttpClient) {
        return new Retrofit.Builder()
                .baseUrl(endPoint)

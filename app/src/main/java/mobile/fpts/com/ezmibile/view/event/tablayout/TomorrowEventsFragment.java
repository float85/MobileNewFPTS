...
public class TomorrowEventsFragment extends Fragment {
    FragEventsTablayoutBinding binding;
    EventTabAdapter adapter;
    ArrayList<EventsApp> eventsAppList = new ArrayList<>();
    boolean bBlackWhite;

    public static TomorrowEventsFragment newInstance(List<EventsApp> list ) {
        TomorrowEventsFragment fragment = new TomorrowEventsFragment();
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            ...
            for (int i = 0; i < events.size(); i++) {
                if (events.get(i).getGroupNm().equals(Define.TAB_TOMORROW_GROUPNM)) {
                    eventsAppList.add(new EventsApp(events.get(i).getiDX(), events.get(i).getGroupNm(), events.get(i).getiD(),
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new EventTabAdapter(eventsAppList, false);

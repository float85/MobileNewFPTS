...
public class YesterdayEventsFragment extends Fragment {
    View view;
    ...
    public static YesterdayEventsFragment newInstance(List<EventsApp> list ) {
        YesterdayEventsFragment fragment = new YesterdayEventsFragment();
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            ...
            for (int i = 0; i < events.size(); i++) {
                if (events.get(i).getGroupNm().equals(Define.TAB_YESTERDAY_GROUPNM)){

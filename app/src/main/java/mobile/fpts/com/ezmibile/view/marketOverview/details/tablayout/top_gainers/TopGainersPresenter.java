...
public class TopGainersPresenter {
    String baseApi;
    ITopGainers view;
    String intURl;
    CompositeSubscription subscription = new CompositeSubscription();

    public TopGainersPresenter(ITopGainers view, int intURl) {
        this.intURl = String.valueOf(intURl);
//        this.baseApi = "http://gateway.fpts.com.vn/g5g/fpts/?s=top_realtime&c="  + intURl + "&type=1";
        this.view = view;
    }

    public void loadDataformServer() {
        subscription.add(ApiClientImp.getInstance().getTopRealtime(intURl, "1")

...
public class DepartmentReportPresenter implements INews.Presenter {
    private INews.View view;
    AppDatabase database;

    public DepartmentReportPresenter(INews.View view) {
        this.view = view;
    ...
    public void getData() {
        ...
        List<NewsArticleDB> listAll = database.newsDao().getNewsListFormStype(Define.Department_Report);
        ...
        view.getDataDone(listNews, Define.Department_Report);
    }
}

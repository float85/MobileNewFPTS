...
public class AnalysisCommentPresenter implements INews.Presenter {
    private INews.View view;
    AppDatabase database;

    public AnalysisCommentPresenter(INews.View view) {
        this.view = view;
    ...
    public void getData() {
        ...
        List<NewsArticleDB> listAll = database.newsDao().getNewsListFormStype(Define.Analysis_Comment);
        ...
        view.getDataDone(listNews, Define.Analysis_Comment);
    }
}

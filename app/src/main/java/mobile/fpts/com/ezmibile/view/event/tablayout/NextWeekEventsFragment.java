...
public class NextWeekEventsFragment extends Fragment {
    ...
    public static NextWeekEventsFragment newInstance(ArrayList<EventsApp> list) {
        NextWeekEventsFragment fragment = new NextWeekEventsFragment();
        Bundle bundle = new Bundle();
        Log.d("NextWeekEventsFragment", "newInstance: " + list.size());
        bundle.putParcelableArrayList("listDataFormRoom",   list);
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            ...
            for (int i = 0; i < events.size(); i++) {
                if (events.get(i).getGroupNm().equals(Define.TAB_NEXTWEEK_GROUPNM)){

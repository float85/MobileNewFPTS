package mobile.fpts.com.ezmibile.view.news.home.analysis_comment;
...
public class AnalysisCommentFragment extends Fragment implements INews.View {
    ...
    public static AnalysisCommentFragment newInstance() {
        AnalysisCommentFragment fragment = new AnalysisCommentFragment();
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        presenter = new AnalysisCommentPresenter(this);
...
//        lvTinTuc.addItemDecoration(new DividerItemDecoration(getContext(), 1));
    ...
    public void moveFragmentView(String id, String img, String folder) {
        ...
        transaction.replace(R.id.contentview, NewsDetailFragment.newInstance(id, img, Define.Analysis_Comment));

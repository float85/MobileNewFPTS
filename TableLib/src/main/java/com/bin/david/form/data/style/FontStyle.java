...
public class FontStyle implements IStyle{
    ...
    private static Paint.Align defaultAlign = Paint.Align.RIGHT;
    ...
    public FontStyle(int textSize, int textColor, Typeface typeface) {
    ...
    public FontStyle setTypeface(Typeface typeface) {
        this.typeface = typeface;
        return this;
    }
